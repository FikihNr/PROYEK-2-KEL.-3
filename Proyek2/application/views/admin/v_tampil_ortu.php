...
<form action="<?php echo base_url();?>index.php/admin/crud_ortu/input_data_ortu" method="post">
  <label>Nama</label><br>
...
<div id="container">
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tr>
			...
			<td>
			      <a href="<?php echo base_url('index.php/admin/crud_ortu/edit_ortu/'); ?><?php echo $u->id_ortu ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
                
                   <a href="<?php echo base_url('index.php/admin/crud_ortu/hapus_data_ortu/'); ?><?php echo $u->id_ortu ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
