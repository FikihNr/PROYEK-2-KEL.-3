...
$this->load->view('pelajar/template/head');
$this->load->view('pelajar/template/topbar');
$this->load->view('pelajar/template/sidebar');
?>
...
<?php
$this->load->view('pelajar/template/js');
?>
...
<?php
$this->load->view('pelajar/template/foot');
?>